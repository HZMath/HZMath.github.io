...
copy from https://github.com/MCDReforged/PluginCatalogue
...
COMMENT_SIGN = "<!--HZMath CI Report-->"

EXECUTABLE = "gh"
PR_NUMBER: str = os.environ.get("PR_NUMBER")  # type: ignore
CATALOGUE_REPO = "HZMath/HZMath.github.io".split("/")
...
def pr_update_or_comment(
    user: str, body: str, pr_number: str = PR_NUMBER, sign: str = COMMENT_SIGN
) -> None:
